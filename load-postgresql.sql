...
FROM 'RF2Release/Full/Terminology/sct2_Concept_Full_AU1000036_20161231.txt' 
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_description_f(id, effectivetime, active, moduleid, conceptid, languagecode, typeid, term, casesignificanceid)
FROM 'RF2Release/Full/Terminology/sct2_Description_Full-en_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_textdefinition_f(id, effectivetime, active, moduleid, conceptid, languagecode, typeid, term, casesignificanceid)
FROM 'RF2Release/Full/Terminology/sct2_TextDefinition_Full-en_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Terminology/sct2_Relationship_Full_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Terminology/sct2_StatedRelationship_Full_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_langrefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, acceptabilityid)
FROM 'RF2Release/Full/Refset/Language/der2_cRefset_LanguageFull-en_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_associationrefset_d(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, targetcomponentid)
FROM 'RF2Release/Full/Refset/Content/der2_cRefset_AssociationReferenceFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_simplerefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid)
FROM 'RF2Release/Full/Refset/Content/der2_Refset_SimpleFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_attributevaluerefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, valueid)
FROM 'RF2Release/Full/Refset/Content/der2_cRefset_AttributeValueFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');

COPY curr_simplemaprefset_f(id, effectivetime, active, moduleid, refsetid,  referencedcomponentid, maptarget)
FROM 'RF2Release/Full/Refset/Map/der2_sRefset_SimpleMapFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Refset/Map/der2_iissscRefset_ComplexMapFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
...
FROM 'RF2Release/Full/Refset/Map/der2_iisssccRefset_ExtendedMapFull_AU1000036_20161231.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	');
